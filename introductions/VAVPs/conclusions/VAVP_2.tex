...
\begin{document}
	\begin{tikzpicture}[scale=0.75]
		...
		\node[outer sep=0pt,thick] at (4.5,0.75) [] {\Large${S}$};
	...
	\pgfmathsetmacro{\distOneTwo}{\rOne+\rTwo+\toothHeight+0.05}
		...
		\begin{scope}[xshift=6.25cm,yshift=4.8cm, rotate=-15.5]
			...
			\node[outer sep=0pt,thick] at (6.5,-5.2) [] {\Large$\phantom{\mathbf{v}_r = {\color{green!50!black}\mathbf{Y}_X } {\color{red} \mathbf{\bar{f}}}}$};
		\end{scope}
		...
		\draw[very thick, black, fill=black] (5.575,1.1) circle[radius=.1];
		\node[outer sep=0pt,thick] at (6.15,4.8) [] {\Large$c$};
