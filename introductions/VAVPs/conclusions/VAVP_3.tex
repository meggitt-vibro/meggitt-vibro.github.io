...
\begin{document}
	\begin{tikzpicture}[scale=0.75]
		 ...
		 \draw[rounded corners, rotate=0, fill=white!50!black, fill opacity=0.5, white!50!black, shift={(0.9,-0.425)}] (4.95,4.1)rectangle (6.3,4.9) node[midway,black,opacity=1] {\Large $I$};

		\draw[rounded corners, rotate=0, fill=white!50!black, fill opacity=0.5, white!50!black, shift={(0.9,-0.45)}] (4.5,1.15)rectangle (5.8,1.95) {};

		\draw [thick,fill=white]  plot[smooth cycle, tension=.6] coordinates {(0,2) (0.5,4.5) (4,5.2) (6,4.5)  (5.35,2.5) (5.5,0.85) (4,0) (1,0.5) };
		\node[outer sep=0pt,thick] at (2.5,0.75) [] {\Large${S}$};
		...
		\begin{scope}[xshift=7.25cm,yshift=4.8cm, rotate=-15.5]
			\draw [thick,fill=white]  plot[smooth cycle, tension=.6] coordinates {(0,-1) (1,-4.5) (6,-4.5) (5,-1) (1,0.3) };
			...
			\draw [-latex,thick,blue]  (5.2,-4.8) --  (5.5,-5.6) node [right,pos=1] {$\mathbf{v}_r$};
