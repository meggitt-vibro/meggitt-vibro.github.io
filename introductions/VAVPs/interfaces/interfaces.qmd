...
::: {#fig-VPexample layout-ncol=2}

![Force position and orientation.](VPT_force.png){width=300 #fig-VPexample_f}

![Triaxial accelerometer position and orientation.](VPT_resp.png){width=300 #fig-VPexample_r}

Example relative coordinates for virtual point transformations. a) - force transformation. b) - response transformation.
:::
