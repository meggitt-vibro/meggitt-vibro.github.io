...
\begin{document}
	\begin{tikzpicture}[scale=0.75]
		...
		\node[outer sep=0pt,thick] at (3.5,1.75) [] {\Large${\mathbf{Y}_S}$};
...
%		\draw [-stealth,line width=1pt,red] (1.7,3) -- ($(1.7,3) +(0.3, -2)$) ; 
		...
		\draw [thick, dashed,fill=white!100!black,]  plot[smooth cycle,  tension=.6] coordinates {(0.4,1.9) (.6,4) (2.8,4.8)  (3.1,3.2) (2.5,2.5) };
		...
		\begin{scope}[xshift=7.25cm,yshift=4.8cm, rotate=-15.5]
			...
			\node[outer sep=0pt,thick] at (3,-2.5) [] {\Large${\mathbf{Y}_R}$};
...
%		 \draw[rounded corners, rotate=0, fill=white!80!black, fill opacity=0.5, white!80!black, shift={(0.9,-0.45)}] (4.8,4.1)rectangle (6.5,4.9) {};
%		
%		\draw[rounded corners, rotate=0, fill=white!80!black, fill opacity=0.5, white!80!black, shift={(0.9,-0.45)}] (4.3,1.15)rectangle (6.1,1.95) {};
		...
		\draw[very thick, black, fill=black] (5.575,1.1) circle[radius=.1];
		\node[outer sep=0pt,thick] at (5.2,4) [] {\Large$c$};
		
			\node[outer sep=0pt,thick] at (7.8,4) [] {\Large$c$};
