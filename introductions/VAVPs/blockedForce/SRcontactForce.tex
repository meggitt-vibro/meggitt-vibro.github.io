...
\begin{scope}[xshift=8.25cm,yshift=4.8cm, rotate=-15.5]
...
\draw[very thick, dashed, latex-latex] (6.1,4.1)--(8.,4.1) node[above,midway] {\Large$g_c$};
\draw[very thick, dashed, latex-latex] (5.675,1.1)--(7.5,1.1) node[above,midway] {};
