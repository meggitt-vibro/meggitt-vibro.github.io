...
% \draw [line width=1pt,red,-latex]  plot[smooth, tension=.6] coordinates { (1.5,2.8) ($(1.5,2.8)+(-0.25,-0.25)$) }; 
% \draw [line width=1pt,red,-latex]  plot[smooth, tension=.6] coordinates { (1.5,4) ($(1.5,4)+(-0.25,0.25)$) }; 
% \draw [line width=1pt,red,-latex]  plot[smooth, tension=.6] coordinates { (2.5,4) ($(2.5,4)+(0.25,0.25)$) }; 
% \draw [line width=1pt,red,-latex]  plot[smooth, tension=.6] coordinates { (2.5,3.2) ($(2.5,3.2)+(0.25,-0.25)$) }; 

% \node[outer sep=0pt,thick] at (2.2,2.4) [] {{\color{red}\Large$\mathbf{{f}}_{i}$}};

% \node[outer sep=0pt,thick] at ($(3.25,5.2)+(0.75,1.5)$) [] {{\Large\color{black!10!purple}$ p(r)$}};
...
\draw[very thick, black, fill=black] (6.,4.1) circle[radius=.1];
\draw[very thick, black, fill=black] (5.575,1.1) circle[radius=.1];
% \draw[very thick, black, fill=black] (8.1,4.1) circle[radius=.1];
% \draw[very thick, black, fill=black] (7.6,1.1) circle[radius=.1];

\draw[very thick,blue, dashed, -latex] (4.6,4.1)--(5.9,4.1) node[pos=0,left] {\Large$-\mathbf{\bar{f}}_c$};
\draw[very thick,blue, dashed, -latex] (4.175,1.1)--(5.50,1.1) node[pos=0,left] {};
