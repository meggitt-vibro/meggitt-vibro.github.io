...
%\node[outer sep=0pt,thick] at (2,3.5) [minimum width=1.5cm, minimum height=1.5cm] {$o$};
 ...
 \node[outer sep=0pt,thick] at (3.8,-0.8) [minimum width=1.5cm, minimum height=1.5cm] {$1$};

\draw [line width=2pt,black,cap=round]  plot[smooth, tension=.6] coordinates { (1,0.33) (1.2,0.31) (1.8,0.25) };  
\node[outer sep=0pt,thick] at (0.9,-0.2) [minimum width=1.5cm, minimum height=1.5cm] {$2$};
...
\draw [line width=2pt,black,cap=round]  plot[smooth, tension=.6] coordinates { (3.2,-0.09) (3.7,-0.26) (3.9,-0.34) };  
\node[outer sep=0pt,thick] at (3.8,-0.8) [minimum width=1.5cm, minimum height=1.5cm] {$3$};

\draw [line width=2pt,black,cap=round]  plot[smooth, tension=.6] coordinates { (1,0.33) (1.2,0.31) (1.8,0.25) };  
\node[outer sep=0pt,thick] at (0.9,-0.2) [minimum width=1.5cm, minimum height=1.5cm] {$4$};
