...
\begin{tikzpicture}[scale=1.5,xshift=0.5cm,every node/.style={outer sep=0pt,thick}]
	...
	\node (x0) at (wall2.south) [right,xshift=-0.9cm,yshift=1cm] {$\phantom{x_2=0}$};
	...
	\draw [-latex, thick] (wall2.north) ++ (0.1,0cm) --  ++ (0.4cm,0cm) node[pos=.5,below] {$-F$};

	\draw [|-latex, thick,dashed] (wall2.north) ++ (0cm,0.25cm) -- ++ (0.5cm, 0cm) node[above,midway] {$x_2$};
