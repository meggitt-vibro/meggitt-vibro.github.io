\begin{tikzpicture}[scale=1.5,xshift=0.5cm,every node/.style={outer sep=0pt,thick}]
	...
	\node (wall2) at (1.1cm,-4cm) [ground, rotate=90, minimum width=3cm] {};
	\draw [ultra thick] (wall2.north east) -- (wall2.north west);
	\draw [spring] (-1cm,-4.8cm) -- ++ (2,0) node[] {};
	\draw [damper] (-1cm,-3.2cm) -- ++ (2,0) node[] {};
	\draw [latex-, thick, blue] (-1.5cm,-3.2cm) --  ++(0.4cm,0cm) node[pos=.5,,below] {$F_k$};
	\draw [latex-, thick, red] (-1.5cm,-4.8cm) --  ++(0.4cm,0cm) node[pos=.5,,below] {$F_c$};	
	\draw [-latex, thick] (-1.5cm,-4cm) --  ++(0.4cm,0cm) node[pos=.5,,below] {$F_e$};	
	\draw [|-latex, thick,dashed] (-1cm,-2.7cm) -- (-0.5cm,-2.7cm) node[above,midway] {$x_1$};
	\draw [ultra thick] (-1cm,-5cm) --  (-1cm,-3cm) ;
