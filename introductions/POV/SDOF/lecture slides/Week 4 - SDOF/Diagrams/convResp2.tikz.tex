...
\begin{axis}[
	...
	\draw [thick,gray!50!white,fill = gray!30!white] (axis cs: 2.8,0) rectangle (axis cs: 3., 2.725);	
...
\begin{axis}[
	...
	\addplot [gray!50!white, thick] coordinates {(0, 0)  (2.8, 0)  (2.8, 1)};
	\addplot[gray!50!white, thick, xshift=72.5,domain=0:2.25] (x, {sqrt(\xo^2+(\dxo/\wdd)^2) * cos(deg(\wdd*(x)- \Phii)) * exp(-\zEta*\wn*x)});
