...
%% MASS 3 
\node[mass,minimum width=1.5cm,minimum height=1.5cm,fill=green!50!white,below right=-1.5cm and 1.5cm of m2] (m3) {$m_3$};  
%% MASS 4 
\node[mass,minimum width=1.5cm,minimum height=1.5cm,fill=green!50!white,above right=-1.5cm and 1.5cm of m2] (m4) {$m_4$};
%% MASS 5
\node[mass,minimum width=1.5cm,minimum height=1.5cm,fill=green!50!white,above right=-1.5cm and 4.5cm of m1] (m5) {$m_5$};
...
%% MASS 1
\node[mass,minimum width=1.5cm,minimum height=5.1cm,fill=blue!50!white,left=1.5cm of g2] (m11) {$m_{11}$};  
%% MASS 2  
\node[mass,minimum width=1.5cm,minimum height=1.5cm,fill=blue!50!white,below left=-1.5cm and 1.5cm of m11] (m9) {$m_{9}$}; 
%% MASS 2  
\node[mass,minimum width=1.5cm,minimum height=3.3cm,fill=blue!50!white,above left=-3.3cm and 1.5cm of m11] (m10) {$m_{10}$}; 
%% MASS 2  
\node[mass,minimum width=1.5cm,minimum height=1.5cm,fill=blue!50!white,above left=-1.5cm and 1.5cm of m10] (m8) {$m_{8}$}; 
\node[mass,minimum width=1.5cm,minimum height=1.5cm,fill=blue!50!white,below left=-1.5cm and 1.5cm of m10] (m7) {$m_{7}$}; 
\node[mass,minimum width=1.5cm,minimum height=1.5cm,fill=blue!50!white,left=1.5cm of m9] (m6) {$m_{6}$};  
